...
func (p *TDataStreamSink) ReadField8(iprot thrift.TProtocol) error {
	p.TabletSinkSchema = descriptors.NewTOlapTableSchemaParam()
	if err := p.TabletSinkSchema.Read(iprot); err != nil {
		return err
	}
	return nil
}
func (p *TDataStreamSink) ReadField9(iprot thrift.TProtocol) error {
	p.TabletSinkPartition = descriptors.NewTOlapTablePartitionParam()
	if err := p.TabletSinkPartition.Read(iprot); err != nil {
		return err
	}
	return nil
}
func (p *TDataStreamSink) ReadField10(iprot thrift.TProtocol) error {
	p.TabletSinkLocation = descriptors.NewTOlapTableLocationParam()
	if err := p.TabletSinkLocation.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *THiveBucket) ReadField2(iprot thrift.TProtocol) error {
	p.BucketMode = NewTBucketingMode()
	if err := p.BucketMode.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *THivePartition) ReadField2(iprot thrift.TProtocol) error {
	p.Location = NewTHiveLocationParams()
	if err := p.Location.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *THiveTableSink) ReadField5(iprot thrift.TProtocol) error {
	p.BucketInfo = NewTHiveBucket()
	if err := p.BucketInfo.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *THiveTableSink) ReadField11(iprot thrift.TProtocol) error {
	p.SerdeProperties = NewTHiveSerDeProperties()
	if err := p.SerdeProperties.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *TDataSink) ReadField13(iprot thrift.TProtocol) error {
	p.HiveTableSink = NewTHiveTableSink()
	if err := p.HiveTableSink.Read(iprot); err != nil {
		return err
	}
	return nil
}
func (p *TDataSink) ReadField14(iprot thrift.TProtocol) error {
	p.IcebergTableSink = NewTIcebergTableSink()
	if err := p.IcebergTableSink.Read(iprot); err != nil {
		return err
	}
	return nil
}
