...
func (p *TFrontendInfo) ReadField1(iprot thrift.TProtocol) error {
	p.CoordinatorAddress = types.NewTNetworkAddress()
	if err := p.CoordinatorAddress.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *TMasterInfo) ReadField1(iprot thrift.TProtocol) error {
	p.NetworkAddress = types.NewTNetworkAddress()
	if err := p.NetworkAddress.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *THeartbeatResult_) ReadField2(iprot thrift.TProtocol) error {
	p.BackendInfo = NewTBackendInfo()
	if err := p.BackendInfo.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *HeartbeatServiceHeartbeatArgs) InitDefault() {
	*p = HeartbeatServiceHeartbeatArgs{}
}
...
func (p *HeartbeatServiceHeartbeatArgs) ReadField1(iprot thrift.TProtocol) error {
	p.MasterInfo = NewTMasterInfo()
	if err := p.MasterInfo.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *HeartbeatServiceHeartbeatResult) InitDefault() {
	*p = HeartbeatServiceHeartbeatResult{}
}
...
func (p *HeartbeatServiceHeartbeatResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewTHeartbeatResult_()
