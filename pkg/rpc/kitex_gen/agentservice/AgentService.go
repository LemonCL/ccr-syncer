...
func (p *TCalcDeleteBitmapPartitionInfo) InitDefault() {
	*p = TCalcDeleteBitmapPartitionInfo{}
}
...
func (p *TAgentTaskRequest) ReadField34(iprot thrift.TProtocol) error {
	p.CleanTrashReq = NewTCleanTrashReq()
	if err := p.CleanTrashReq.Read(iprot); err != nil {
		return err
	}
	return nil
}
func (p *TAgentTaskRequest) ReadField35(iprot thrift.TProtocol) error {
	p.VisibleVersionReq = NewTVisibleVersionReq()
	if err := p.VisibleVersionReq.Read(iprot); err != nil {
		return err
	}
	return nil
}
func (p *TAgentTaskRequest) ReadField36(iprot thrift.TProtocol) error {
	p.CleanUdfCacheReq = NewTCleanUDFCacheReq()
	if err := p.CleanUdfCacheReq.Read(iprot); err != nil {
		return err
	}
	return nil
}
func (p *TAgentTaskRequest) ReadField1000(iprot thrift.TProtocol) error {
	p.CalcDeleteBitmapReq = NewTCalcDeleteBitmapRequest()
	if err := p.CalcDeleteBitmapReq.Read(iprot); err != nil {
		return err
	}
	return nil
}
