...
func (p *TTableDescriptor) ReadField22(iprot thrift.TProtocol) error {
	p.TrinoConnectorTable = NewTTrinoConnectorTable()
	if err := p.TrinoConnectorTable.Read(iprot); err != nil {
		return err
	}
	return nil
}
func (p *TTableDescriptor) ReadField23(iprot thrift.TProtocol) error {
	p.LakesoulTable = NewTLakeSoulTable()
	if err := p.LakesoulTable.Read(iprot); err != nil {
		return err
	}
	return nil
}
